...
from config import CHANNEL_ID, OWNER_ID, API_ID as api_id, API_HASH as api_hash
   ...
   if update_channel:
      try:
         ...
         if user.status == "kicked":
            await message.reply_text("Sorry Sir, You are Banned. Contact -- Atul")
            return 1
         ...
         await message.reply_text("Something Went Wrong. Contact Atul ...")
         return 1
...
**__Speed__** : {3}/s
**__Time__** : {4}\n\n
**__Powered by [Atul](tg://openmessage?user_id=1303122772)__**
"""
